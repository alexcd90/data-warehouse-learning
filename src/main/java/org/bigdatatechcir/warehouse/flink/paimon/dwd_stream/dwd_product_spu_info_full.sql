...
SET 'pipeline.name' = 'paimon_dwd_stream_dwd_product_spu_info_full';
...
CREATE TABLE IF NOT EXISTS dwd_stream.dwd_product_spu_info_full(
...
FROM ods.ods_spu_poster_full
WHERE is_deleted = 0
GROUP BY spu_id;

INSERT INTO dwd_stream.dwd_product_spu_info_full(
    id,
    k1,
    spu_id,
    spu_name,
