...
CREATE TABLE IF NOT EXISTS dws.dws_trade_province_sku_order_1d_full(
...
INSERT INTO dws.dws_trade_province_sku_order_1d_full(
    province_id,
    sku_id,
    k1,
    province_name,
...
LEFT JOIN dim.dim_province_full p
