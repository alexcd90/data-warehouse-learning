...
SET 'pipeline.name' = 'paimon_ads_stream_ads_trade_stats_by_cate_full';
...
CREATE TABLE IF NOT EXISTS ads_stream.ads_trade_stats_by_cate_full(
...
FROM dws_stream.dws_trade_user_sku_order_1d_full o
...
JOIN dws_stream.dws_trade_user_sku_order_nd_full o
...
FROM dws_stream.dws_trade_user_sku_order_refund_1d_full r
...
FROM tmp_ads_trade_stats_by_cate_recent_days p
JOIN dws_stream.dws_trade_user_sku_order_refund_nd_full r
...
INSERT INTO ads_stream.ads_trade_stats_by_cate_full(
    dt,
    recent_days,
    category1_id,
    category1_name,
