...
SET 'pipeline.name' = 'paimon_dwd_stream_dwd_tool_coupon_pay_full';
...
CREATE TABLE IF NOT EXISTS dwd_stream.dwd_tool_coupon_pay_full(
...
insert into dwd_stream.dwd_tool_coupon_pay_full(
    id,
    k1,
    coupon_id,
    user_id,
