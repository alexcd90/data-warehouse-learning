...
SET 'pipeline.name' = 'paimon_dws_stream_dws_trade_user_order_1d_full';
...
CREATE TABLE IF NOT EXISTS dws_stream.dws_trade_user_order_1d_full(
...
INSERT INTO dws_stream.dws_trade_user_order_1d_full(
    user_id,
    k1,
    order_count_1d,
    order_num_1d,
