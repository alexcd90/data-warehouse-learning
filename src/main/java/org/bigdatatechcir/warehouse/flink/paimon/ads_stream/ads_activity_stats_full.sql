...
SET 'pipeline.name' = 'paimon_ads_stream_ads_activity_stats_full';
...
CREATE TABLE IF NOT EXISTS ads_stream.ads_activity_stats_full(
...
INSERT INTO ads_stream.ads_activity_stats_full(
    dt,
    activity_id,
    activity_name,
    start_date,
...
SELECT
    ...
    END AS reduce_rate
FROM dws_stream.dws_trade_activity_order_nd_full
