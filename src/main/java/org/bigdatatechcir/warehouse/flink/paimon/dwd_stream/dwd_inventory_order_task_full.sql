...
SET 'pipeline.name' = 'paimon_dwd_stream_dwd_inventory_order_task_full';
...
CREATE TABLE IF NOT EXISTS dwd_stream.dwd_inventory_order_task_full(
...
INSERT INTO dwd_stream.dwd_inventory_order_task_full(
    id,
    k1,
    task_id,
    order_id,
