...
SET 'pipeline.name' = 'paimon_dwd_stream_dwd_product_sku_info_full';
...
CREATE TABLE IF NOT EXISTS dwd_stream.dwd_product_sku_info_full(
...
INSERT INTO dwd_stream.dwd_product_sku_info_full(
    id,
    k1,
    sku_id,
    spu_id,
