...
SET 'pipeline.name' = 'paimon_ads_stream_ads_sku_cart_num_top3_by_cate_full';
...
CREATE TABLE IF NOT EXISTS ads_stream.ads_sku_cart_num_top3_by_cate_full(
...
INSERT INTO ads_stream.ads_sku_cart_num_top3_by_cate_full(
    dt,
    category1_id,
    category1_name,
    category2_id,
