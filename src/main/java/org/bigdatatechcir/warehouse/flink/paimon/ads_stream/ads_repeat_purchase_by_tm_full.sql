...
SET 'pipeline.name' = 'paimon_ads_stream_ads_repeat_purchase_by_tm_full';
...
CREATE TABLE IF NOT EXISTS ads_stream.ads_repeat_purchase_by_tm_full(
...
INSERT INTO ads_stream.ads_repeat_purchase_by_tm_full(
    dt,
    recent_days,
    tm_id,
    tm_name,
