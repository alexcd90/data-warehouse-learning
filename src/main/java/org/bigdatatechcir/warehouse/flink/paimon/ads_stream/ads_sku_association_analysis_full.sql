...
SET 'pipeline.name' = 'paimon_ads_stream_ads_sku_association_analysis_full';
...
CREATE TABLE IF NOT EXISTS ads_stream.ads_sku_association_analysis_full(
...
INSERT INTO ads_stream.ads_sku_association_analysis_full(
    dt,
    recent_days,
    source_sku_id,
    source_sku_name,
