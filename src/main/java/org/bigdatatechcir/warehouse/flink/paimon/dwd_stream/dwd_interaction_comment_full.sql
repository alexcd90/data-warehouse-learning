...
SET 'pipeline.name' = 'paimon_dwd_stream_dwd_interaction_comment_full';
...
CREATE TABLE IF NOT EXISTS dwd_stream.dwd_interaction_comment_full(
...
insert into dwd_stream.dwd_interaction_comment_full(
    id,
    k1,
    user_id,
    sku_id,
