...
SET 'pipeline.name' = 'paimon_dwd_stream_dwd_inventory_order_task_detail_full';
...
CREATE TABLE IF NOT EXISTS dwd_stream.dwd_inventory_order_task_detail_full(
...
INSERT INTO dwd_stream.dwd_inventory_order_task_detail_full(
    id,
    k1,
    task_id,
    order_id,
...
FROM ods.ods_ware_order_task_detail_full wotd
LEFT JOIN
(
    SELECT
        id,
...
LEFT JOIN ods.ods_ware_info_full wi
...
(
    ...
    LEFT JOIN ods.ods_order_info_full oi
