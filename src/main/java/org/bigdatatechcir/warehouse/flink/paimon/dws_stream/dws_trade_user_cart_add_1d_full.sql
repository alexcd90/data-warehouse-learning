...
SET 'pipeline.name' = 'paimon_dws_stream_dws_trade_user_cart_add_1d_full';
...
CREATE TABLE IF NOT EXISTS dws_stream.dws_trade_user_cart_add_1d_full(
...
INSERT INTO dws_stream.dws_trade_user_cart_add_1d_full(
    user_id,
    k1,
    cart_add_count_1d,
    cart_add_num_1d
...
FROM dwd_stream.dwd_trade_cart_add_full
GROUP BY user_id, k1;
