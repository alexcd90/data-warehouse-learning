...
SET 'pipeline.name' = 'paimon_dwd_stream_dwd_product_category_full';
...
CREATE TABLE IF NOT EXISTS dwd_stream.dwd_product_category_full(
...
INSERT INTO dwd_stream.dwd_product_category_full(
    id,
    k1,
    category_id,
    category_name,
...
FROM ods.ods_base_category1_full c1
UNION ALL
SELECT
