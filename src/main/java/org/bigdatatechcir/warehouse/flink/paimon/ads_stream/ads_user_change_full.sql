...
SET 'pipeline.name' = 'paimon_ads_stream_ads_user_change_full';
...
CREATE TABLE IF NOT EXISTS ads_stream.ads_user_change_full(
...
INSERT INTO ads_stream.ads_user_change_full(
    dt,
    user_churn_count,
    user_back_count
)
