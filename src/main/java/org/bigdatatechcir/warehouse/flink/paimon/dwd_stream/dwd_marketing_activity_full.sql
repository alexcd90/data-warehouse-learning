...
SET 'pipeline.name' = 'paimon_dwd_stream_dwd_marketing_activity_full';
...
CREATE TABLE IF NOT EXISTS dwd_stream.dwd_marketing_activity_full(
...
INSERT INTO dwd_stream.dwd_marketing_activity_full(
    id,
    k1,
    activity_id,
    activity_name,
