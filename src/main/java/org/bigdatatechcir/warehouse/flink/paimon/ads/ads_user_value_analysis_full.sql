...
CREATE TABLE IF NOT EXISTS ads.ads_user_value_analysis_full(
...
FROM ads.ads_user_value_analysis_full p
...
FROM dws.dws_trade_user_order_td_full o
LEFT JOIN dws.dws_user_user_login_td_full l
...
INSERT INTO ads.ads_user_value_analysis_full(
    dt,
    user_id,
    order_count_td,
    order_amount_td,
