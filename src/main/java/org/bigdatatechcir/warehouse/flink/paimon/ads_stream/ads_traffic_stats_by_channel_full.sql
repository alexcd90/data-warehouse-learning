...
SET 'pipeline.name' = 'paimon_ads_stream_ads_traffic_stats_by_channel_full';
...
CREATE TABLE IF NOT EXISTS ads_stream.ads_traffic_stats_by_channel_full(
...
INSERT INTO ads_stream.ads_traffic_stats_by_channel_full(
    dt,
    recent_days,
    channel,
    uv_count,
...
JOIN dws_stream.dws_traffic_session_page_view_1d_full s
