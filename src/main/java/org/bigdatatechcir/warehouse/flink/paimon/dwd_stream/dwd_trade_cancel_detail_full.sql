...
SET 'pipeline.name' = 'paimon_dwd_stream_dwd_trade_cancel_detail_full';
...
CREATE TABLE IF NOT EXISTS dwd_stream.dwd_trade_cancel_detail_full(
...
INSERT INTO dwd_stream.dwd_trade_cancel_detail_full(
    id,
    k1,
    order_id,
    user_id,
