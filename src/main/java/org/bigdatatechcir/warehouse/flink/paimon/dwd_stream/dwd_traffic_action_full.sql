...
SET 'pipeline.name' = 'paimon_dwd_stream_dwd_traffic_action_full';
...
CREATE TABLE IF NOT EXISTS dwd_stream.dwd_traffic_action_full(
    `id`               STRING,
...
insert into dwd_stream.dwd_traffic_action_full(
    id,
    k1,
    province_id,
    brand,
