...
SET 'pipeline.name' = 'paimon_ads_stream_ads_user_stats_full';
...
CREATE TABLE IF NOT EXISTS ads_stream.ads_user_stats_full(
...
INSERT INTO ads_stream.ads_user_stats_full(
    dt,
    recent_days,
    new_user_count,
    active_user_count
