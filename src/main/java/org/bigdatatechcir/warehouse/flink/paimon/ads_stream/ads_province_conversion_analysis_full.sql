...
SET 'pipeline.name' = 'paimon_ads_stream_ads_province_conversion_analysis_full';
...
CREATE TABLE IF NOT EXISTS ads_stream.ads_province_conversion_analysis_full(
...
FROM dim_stream.dim_province_full p
CROSS JOIN (
...
INSERT INTO ads_stream.ads_province_conversion_analysis_full(
    dt,
    recent_days,
    province_id,
    province_name,
