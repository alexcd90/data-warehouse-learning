...
SET 'pipeline.name' = 'paimon_dws_stream_dws_trade_province_order_nd_full';
...
CREATE TABLE IF NOT EXISTS dws_stream.dws_trade_province_order_nd_full(
...
INSERT INTO dws_stream.dws_trade_province_order_nd_full(
    province_id,
    k1,
    province_name,
    area_code,
