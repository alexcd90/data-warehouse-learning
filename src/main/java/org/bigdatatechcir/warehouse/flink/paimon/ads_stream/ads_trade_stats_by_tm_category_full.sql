...
SET 'pipeline.name' = 'paimon_ads_stream_ads_trade_stats_by_tm_category_full';
...
CREATE TABLE IF NOT EXISTS ads_stream.ads_trade_stats_by_tm_category_full(
...
INSERT INTO ads_stream.ads_trade_stats_by_tm_category_full(
    dt,
    recent_days,
    tm_id,
    tm_name,
