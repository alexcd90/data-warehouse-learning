...
SET 'pipeline.name' = 'paimon_dwd_stream_dwd_user_info_full';
...
CREATE TABLE IF NOT EXISTS dwd_stream.dwd_user_info_full(
...
INSERT INTO dwd_stream.dwd_user_info_full(
    id,
    k1,
    user_id,
    login_name,
