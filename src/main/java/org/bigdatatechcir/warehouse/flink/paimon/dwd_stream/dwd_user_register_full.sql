...
SET 'pipeline.name' = 'paimon_dwd_stream_dwd_user_register_full';
...
CREATE TABLE IF NOT EXISTS dwd_stream.dwd_user_register_full(
...
INSERT INTO dwd_stream.dwd_user_register_full(
    id,
    k1,
    user_id,
    date_id,
