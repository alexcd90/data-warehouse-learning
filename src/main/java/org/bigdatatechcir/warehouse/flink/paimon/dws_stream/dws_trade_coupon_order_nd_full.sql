...
SET 'pipeline.name' = 'paimon_dws_stream_dws_trade_coupon_order_nd_full';
...
CREATE TABLE IF NOT EXISTS dws_stream.dws_trade_coupon_order_nd_full(
...
CREATE TEMPORARY VIEW tmp_dws_trade_coupon_order_nd_coupon_union AS
    ...
    FROM dim_stream.dim_coupon_full
    ...
    FROM dwd_stream.dwd_tool_coupon_order_full c
    JOIN dwd_stream.dwd_trade_order_detail_full od
...
INSERT INTO dws_stream.dws_trade_coupon_order_nd_full(
    coupon_id,
    k1,
    coupon_name,
    coupon_type_code,
