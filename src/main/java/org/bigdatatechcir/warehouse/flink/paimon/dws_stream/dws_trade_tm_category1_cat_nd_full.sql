...
SET 'pipeline.name' = 'paimon_dws_stream_dws_trade_tm_category1_cat_nd_full';
...
CREATE TABLE IF NOT EXISTS dws_stream.dws_trade_tm_category1_cat_nd_full(
...
max_sku_date AS (
    ...
    FROM dim_stream.dim_sku_full
),
latest_sku AS (
    SELECT s.*
    FROM dim_stream.dim_sku_full s
...
detail_by_day_sku AS (
    ...
    FROM dwd_stream.dwd_trade_order_detail_full od
...
INSERT INTO dws_stream.dws_trade_tm_category1_cat_nd_full(
    tm_id,
    category1_id,
    k1,
    tm_name,
