...
SET 'pipeline.name' = 'paimon_dwd_stream_dwd_traffic_start_full';
...
CREATE TABLE IF NOT EXISTS dwd_stream.dwd_traffic_start_full(
    `id`              STRING,
...
INSERT INTO dwd_stream.dwd_traffic_start_full(
    id,
    k1,
    province_id,
    brand,
