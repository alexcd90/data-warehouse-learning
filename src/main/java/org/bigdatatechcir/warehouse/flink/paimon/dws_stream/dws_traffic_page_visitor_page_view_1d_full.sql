...
SET 'pipeline.name' = 'paimon_dws_stream_dws_traffic_page_visitor_page_view_1d_full';
...
CREATE TABLE IF NOT EXISTS dws_stream.dws_traffic_page_visitor_page_view_1d_full(
...
INSERT INTO dws_stream.dws_traffic_page_visitor_page_view_1d_full(
    mid_id,
    k1,
    brand,
    model,
...
FROM dwd_stream.dwd_traffic_page_view_full
