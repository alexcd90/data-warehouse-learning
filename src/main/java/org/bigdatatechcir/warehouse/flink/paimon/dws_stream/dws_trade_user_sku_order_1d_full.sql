...
SET 'pipeline.name' = 'paimon_dws_stream_dws_trade_user_sku_order_1d_full';
...
CREATE TABLE IF NOT EXISTS dws_stream.dws_trade_user_sku_order_1d_full(
...
INSERT INTO dws_stream.dws_trade_user_sku_order_1d_full(
    user_id,
    sku_id,
    k1,
    sku_name,
