...
SET 'pipeline.name' = 'iceberg_ads_stream_ads_page_path_full';
...
CREATE TABLE IF NOT EXISTS iceberg_ads_stream.ads_page_path_full(
...
SELECT
    ...
    pv.view_time,
    pv.page_id
FROM iceberg_dwd.dwd_traffic_page_view_full pv
...
INSERT INTO iceberg_ads_stream.ads_page_path_full(
    dt,
    recent_days,
    source,
    target,
