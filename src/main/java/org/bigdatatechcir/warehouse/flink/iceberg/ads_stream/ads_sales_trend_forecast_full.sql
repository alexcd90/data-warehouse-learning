...
SET 'pipeline.name' = 'iceberg_ads_stream_ads_sales_trend_forecast_full';
...
CREATE TABLE IF NOT EXISTS iceberg_ads_stream.ads_sales_trend_forecast_full(
...
INSERT INTO iceberg_ads_stream.ads_sales_trend_forecast_full(
    dt,
    forecast_date,
    forecast_type,
    dimension_id,
