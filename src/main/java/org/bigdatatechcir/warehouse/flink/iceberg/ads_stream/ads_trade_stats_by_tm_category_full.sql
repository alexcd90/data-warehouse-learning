...
SET 'pipeline.name' = 'iceberg_ads_stream_ads_trade_stats_by_tm_category_full';
...
CREATE TABLE IF NOT EXISTS iceberg_ads_stream.ads_trade_stats_by_tm_category_full(
...
CREATE TEMPORARY VIEW tmp_ads_trade_stats_by_tm_category_order_detail_snapshot AS
SELECT *
FROM iceberg_dwd.dwd_trade_order_detail_full
;

CREATE TEMPORARY VIEW tmp_ads_trade_stats_by_tm_category_dim_sku_snapshot AS
SELECT *
...
INSERT INTO iceberg_ads_stream.ads_trade_stats_by_tm_category_full(
    dt,
    recent_days,
    tm_id,
    tm_name,
