...
CREATE TABLE IF NOT EXISTS iceberg_dwd.dwd_inventory_order_task_detail_full(
...
INSERT INTO iceberg_dwd.dwd_inventory_order_task_detail_full /*+ OPTIONS('upsert-enabled' = 'true') */(
    id,
    k1,
    task_id,
    order_id,
