...
CREATE TABLE IF NOT EXISTS iceberg_ads.ads_traffic_stats_by_channel_full(
...
INSERT INTO iceberg_ads.ads_traffic_stats_by_channel_full /*+ OPTIONS('upsert-enabled' = 'true') */(
    dt,
    recent_days,
    channel,
    uv_count,
...
JOIN iceberg_dws.dws_traffic_session_page_view_1d_full s
