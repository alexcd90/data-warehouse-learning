...
SET 'pipeline.name' = 'iceberg_dws_stream_dws_trade_user_payment_td_full';
...
CREATE TABLE IF NOT EXISTS iceberg_dws_stream.dws_trade_user_payment_td_full(
...
INSERT INTO iceberg_dws_stream.dws_trade_user_payment_td_full(
    user_id,
    k1,
    payment_date_first,
    payment_date_last,
