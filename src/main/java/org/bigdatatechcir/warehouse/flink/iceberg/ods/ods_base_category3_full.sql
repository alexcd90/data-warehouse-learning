...
CREATE TABLE IF NOT EXISTS iceberg_ods.ods_base_category3_full(
    `id` bigint NOT NULL  COMMENT '编号',
...
INSERT INTO iceberg_ods.ods_base_category3_full /*+ OPTIONS('upsert-enabled' = 'true') */(`id`, `name`, `category2_id`)
select
    id,
    name,
    category2_id
