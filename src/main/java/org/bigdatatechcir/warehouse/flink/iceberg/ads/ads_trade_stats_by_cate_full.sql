...
CREATE TABLE IF NOT EXISTS iceberg_ads.ads_trade_stats_by_cate_full(
...
FROM iceberg_dws.dws_trade_user_sku_order_1d_full o
WHERE o.k1 = '${pdate}'
...
JOIN iceberg_dws.dws_trade_user_sku_order_nd_full o
    ON o.k1 = '${pdate}'
...
FROM iceberg_dws.dws_trade_user_sku_order_refund_1d_full r
WHERE r.k1 = '${pdate}'
...
FROM tmp_ads_trade_stats_by_cate_recent_days p
JOIN iceberg_dws.dws_trade_user_sku_order_refund_nd_full r
    ON r.k1 = '${pdate}'
...
INSERT INTO iceberg_ads.ads_trade_stats_by_cate_full /*+ OPTIONS('upsert-enabled' = 'true') */(
    dt,
    recent_days,
    category1_id,
    category1_name,
