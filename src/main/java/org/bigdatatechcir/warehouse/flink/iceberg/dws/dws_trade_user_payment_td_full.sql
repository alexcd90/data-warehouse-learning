...
CREATE TABLE IF NOT EXISTS iceberg_dws.dws_trade_user_payment_td_full(
...
INSERT INTO iceberg_dws.dws_trade_user_payment_td_full /*+ OPTIONS('upsert-enabled' = 'true') */(
    user_id,
    k1,
    payment_date_first,
    payment_date_last,
