...
SET 'pipeline.name' = 'iceberg_dws_stream_dws_trade_province_sku_order_nd_full';
...
CREATE TABLE IF NOT EXISTS iceberg_dws_stream.dws_trade_province_sku_order_nd_full(
...
source_1d AS (
    ...
    FROM iceberg_dws_stream.dws_trade_province_sku_order_1d_full
),
current_data AS (
    SELECT
        s.province_id,
...
INSERT INTO iceberg_dws_stream.dws_trade_province_sku_order_nd_full(
    province_id,
    sku_id,
    k1,
    province_name,
