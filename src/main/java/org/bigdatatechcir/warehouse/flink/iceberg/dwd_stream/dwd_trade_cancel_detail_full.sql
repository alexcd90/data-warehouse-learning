...
SET 'pipeline.name' = 'iceberg_dwd_stream_dwd_trade_cancel_detail_full';
...
CREATE TABLE IF NOT EXISTS iceberg_dwd_stream.dwd_trade_cancel_detail_full(
...
INSERT INTO iceberg_dwd_stream.dwd_trade_cancel_detail_full(
    id,
    k1,
    order_id,
    user_id,
