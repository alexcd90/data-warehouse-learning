...
CREATE TABLE IF NOT EXISTS iceberg_dws.dws_trade_province_sku_order_1d_full(
...
INSERT INTO iceberg_dws.dws_trade_province_sku_order_1d_full /*+ OPTIONS('upsert-enabled' = 'true') */(
    province_id,
    sku_id,
    k1,
    province_name,
...
LEFT JOIN iceberg_dim.dim_province_full p
