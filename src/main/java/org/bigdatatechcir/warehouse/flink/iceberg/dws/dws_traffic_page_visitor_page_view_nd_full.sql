...
CREATE TABLE IF NOT EXISTS iceberg_dws.dws_traffic_page_visitor_page_view_nd_full(
...
INSERT INTO iceberg_dws.dws_traffic_page_visitor_page_view_nd_full /*+ OPTIONS('upsert-enabled' = 'true') */(
    mid_id,
    page_id,
    k1,
    brand,
