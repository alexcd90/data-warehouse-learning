...
SET 'pipeline.name' = 'iceberg_dws_stream_dws_trade_province_sku_order_1d_full';
...
CREATE TABLE IF NOT EXISTS iceberg_dws_stream.dws_trade_province_sku_order_1d_full(
...
INSERT INTO iceberg_dws_stream.dws_trade_province_sku_order_1d_full(
    province_id,
    sku_id,
    k1,
    province_name,
...
LEFT JOIN iceberg_dim_stream.dim_province_full p
