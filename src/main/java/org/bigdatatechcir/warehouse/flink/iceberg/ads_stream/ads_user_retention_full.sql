...
SET 'pipeline.name' = 'iceberg_ads_stream_ads_user_retention_full';
...
CREATE TABLE IF NOT EXISTS iceberg_ads_stream.ads_user_retention_full(
...
INSERT INTO iceberg_ads_stream.ads_user_retention_full(
    dt,
    create_date,
    retention_day,
    retention_count,
