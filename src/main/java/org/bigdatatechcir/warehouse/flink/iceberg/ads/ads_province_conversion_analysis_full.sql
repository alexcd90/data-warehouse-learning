...
INSERT INTO iceberg_ads.ads_province_conversion_analysis_full /*+ OPTIONS('upsert-enabled' = 'true') */(dt, recent_days, province_id, province_name, region_id, region_name, 
...
FROM
    -- 省份维度表: 生成所有需要统计的省份清单
    iceberg_dim.dim_province_full p
CROSS JOIN
