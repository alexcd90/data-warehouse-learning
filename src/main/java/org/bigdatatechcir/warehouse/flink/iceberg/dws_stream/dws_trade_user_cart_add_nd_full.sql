...
SET 'pipeline.name' = 'iceberg_dws_stream_dws_trade_user_cart_add_nd_full';
...
CREATE TABLE IF NOT EXISTS iceberg_dws_stream.dws_trade_user_cart_add_nd_full(
...
INSERT INTO iceberg_dws_stream.dws_trade_user_cart_add_nd_full(
    user_id,
    k1,
    cart_add_count_7d,
    cart_add_num_7d,
