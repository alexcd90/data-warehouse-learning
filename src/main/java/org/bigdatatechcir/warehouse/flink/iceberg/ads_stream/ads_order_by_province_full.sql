...
SET 'pipeline.name' = 'iceberg_ads_stream_ads_order_by_province_full';
...
CREATE TABLE IF NOT EXISTS iceberg_ads_stream.ads_order_by_province_full(
...
INSERT INTO iceberg_ads_stream.ads_order_by_province_full(
    dt,
    recent_days,
    province_id,
    province_name,
...
FROM iceberg_dws_stream.dws_trade_province_order_1d_full
...
FROM iceberg_dws_stream.dws_trade_province_order_nd_full n
