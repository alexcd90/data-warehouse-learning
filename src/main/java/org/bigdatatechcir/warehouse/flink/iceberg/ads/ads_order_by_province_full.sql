...
CREATE TABLE IF NOT EXISTS iceberg_ads.ads_order_by_province_full(
...
INSERT INTO iceberg_ads.ads_order_by_province_full /*+ OPTIONS('upsert-enabled' = 'true') */(
    dt,
    recent_days,
    province_id,
    province_name,
...
FROM iceberg_dws.dws_trade_province_order_nd_full n
