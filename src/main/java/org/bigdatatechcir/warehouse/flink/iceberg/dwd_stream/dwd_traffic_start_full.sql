...
SET 'pipeline.name' = 'iceberg_dwd_stream_dwd_traffic_start_full';
...
CREATE TABLE IF NOT EXISTS iceberg_dwd_stream.dwd_traffic_start_full(
    `id`              STRING,
...
INSERT INTO iceberg_dwd_stream.dwd_traffic_start_full(
    id,
    k1,
    province_id,
    brand,
