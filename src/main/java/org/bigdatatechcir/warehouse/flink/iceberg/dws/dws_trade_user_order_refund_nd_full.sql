...
CREATE TABLE IF NOT EXISTS iceberg_dws.dws_trade_user_order_refund_nd_full(
...
INSERT INTO iceberg_dws.dws_trade_user_order_refund_nd_full /*+ OPTIONS('upsert-enabled' = 'true') */(
    user_id,
    k1,
