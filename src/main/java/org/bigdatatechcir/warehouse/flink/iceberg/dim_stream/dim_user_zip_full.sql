...
SET 'pipeline.name' = 'iceberg_dim_stream_dim_user_zip_full';
...
CREATE TABLE IF NOT EXISTS iceberg_dim_stream.dim_user_zip_full(
...
insert into iceberg_dim_stream.dim_user_zip_full(
    id,
    k1,
    login_name,
    nick_name,
