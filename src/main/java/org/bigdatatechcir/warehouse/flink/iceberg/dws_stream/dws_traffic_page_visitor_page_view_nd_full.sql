...
SET 'pipeline.name' = 'iceberg_dws_stream_dws_traffic_page_visitor_page_view_nd_full';
...
CREATE TABLE IF NOT EXISTS iceberg_dws_stream.dws_traffic_page_visitor_page_view_nd_full(
...
INSERT INTO iceberg_dws_stream.dws_traffic_page_visitor_page_view_nd_full(
    mid_id,
    page_id,
    k1,
    brand,
