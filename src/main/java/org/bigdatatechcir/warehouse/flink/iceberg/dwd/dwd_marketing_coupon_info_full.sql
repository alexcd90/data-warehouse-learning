...
CREATE TABLE IF NOT EXISTS iceberg_dwd.dwd_marketing_coupon_info_full(
...
INSERT INTO iceberg_dwd.dwd_marketing_coupon_info_full /*+ OPTIONS('upsert-enabled' = 'true') */(
    id,
    k1,
    coupon_id,
    coupon_name,
