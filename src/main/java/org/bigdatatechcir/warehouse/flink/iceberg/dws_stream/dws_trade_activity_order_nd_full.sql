...
SET 'pipeline.name' = 'iceberg_dws_stream_dws_trade_activity_order_nd_full';
...
CREATE TABLE IF NOT EXISTS iceberg_dws_stream.dws_trade_activity_order_nd_full(
...
CREATE TEMPORARY VIEW tmp_dws_trade_activity_order_nd_activity_union AS
    ...
    FROM iceberg_dim_stream.dim_activity_full
...
INSERT INTO iceberg_dws_stream.dws_trade_activity_order_nd_full(
    activity_id,
    k1,
    activity_name,
    activity_type_code,
