...
SET 'pipeline.name' = 'iceberg_ads_stream_ads_trade_stats_by_tm_full';
...
CREATE TABLE IF NOT EXISTS iceberg_ads_stream.ads_trade_stats_by_tm_full(
...
INSERT INTO iceberg_ads_stream.ads_trade_stats_by_tm_full(
    dt,
    recent_days,
    tm_id,
    tm_name,
