...
CREATE TABLE IF NOT EXISTS iceberg_ads.ads_trade_stats_full(
...
CREATE TEMPORARY VIEW tmp_ads_trade_stats_order_nd_stats AS
    ...
    LEFT JOIN iceberg_dws.dws_trade_user_order_nd_full o
        ON o.k1 = '${pdate}'
...
CREATE TEMPORARY VIEW tmp_ads_trade_stats_refund_1d_stats AS
    ...
    FROM iceberg_dws.dws_trade_user_order_refund_1d_full
    WHERE k1 = '${pdate}'
;
...
CREATE TEMPORARY VIEW tmp_ads_trade_stats_refund_nd_stats AS
    ...
    FROM tmp_ads_trade_stats_recent_days r
    LEFT JOIN iceberg_dws.dws_trade_user_order_refund_nd_full f
        ON f.k1 = '${pdate}'
    GROUP BY r.recent_days
;

INSERT INTO iceberg_ads.ads_trade_stats_full /*+ OPTIONS('upsert-enabled' = 'true') */(
    dt,
    recent_days,
    order_total_amount,
    order_count,
