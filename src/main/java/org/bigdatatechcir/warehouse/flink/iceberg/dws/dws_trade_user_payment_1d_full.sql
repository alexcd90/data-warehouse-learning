...
CREATE TABLE IF NOT EXISTS iceberg_dws.dws_trade_user_payment_1d_full(
...
INSERT INTO iceberg_dws.dws_trade_user_payment_1d_full /*+ OPTIONS('upsert-enabled' = 'true') */(
    user_id,
    k1,
    payment_count_1d,
    payment_num_1d,
