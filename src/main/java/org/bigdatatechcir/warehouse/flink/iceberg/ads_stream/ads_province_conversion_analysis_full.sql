...
SET 'pipeline.name' = 'iceberg_ads_stream_ads_province_conversion_analysis_full';
...
CREATE TABLE IF NOT EXISTS iceberg_ads_stream.ads_province_conversion_analysis_full(
...
CREATE TEMPORARY VIEW tmp_ads_province_conversion_order_detail_snapshot AS
SELECT *
FROM iceberg_dwd.dwd_trade_order_detail_full
;

CREATE TEMPORARY VIEW tmp_ads_province_conversion_pay_detail_snapshot AS
SELECT *
FROM iceberg_dwd.dwd_trade_pay_detail_suc_full
;
...
FROM iceberg_dim_stream.dim_province_full p
CROSS JOIN (
...
INSERT INTO iceberg_ads_stream.ads_province_conversion_analysis_full(
    dt,
    recent_days,
    province_id,
    province_name,
