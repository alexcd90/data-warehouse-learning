...
SET 'pipeline.name' = 'iceberg_ads_stream_ads_trade_stats_by_cate_full';
...
CREATE TABLE IF NOT EXISTS iceberg_ads_stream.ads_trade_stats_by_cate_full(
...
FROM iceberg_dws_stream.dws_trade_user_sku_order_1d_full o
...
FROM iceberg_dws_stream.dws_trade_user_sku_order_refund_1d_full r
...
FROM tmp_ads_trade_stats_by_cate_recent_days p
JOIN iceberg_dws_stream.dws_trade_user_sku_order_refund_nd_full r
...
INSERT INTO iceberg_ads_stream.ads_trade_stats_by_cate_full(
    dt,
    recent_days,
    category1_id,
    category1_name,
