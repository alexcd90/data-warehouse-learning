...
SET 'pipeline.name' = 'iceberg_dws_stream_dws_trade_user_sku_order_refund_nd_full';
...
CREATE TABLE IF NOT EXISTS iceberg_dws_stream.dws_trade_user_sku_order_refund_nd_full(
...
CREATE TEMPORARY VIEW tmp_dws_trade_user_sku_order_refund_nd_refund_1d AS
    ...
    FROM iceberg_dws_stream.dws_trade_user_sku_order_refund_1d_full
;
...
INSERT INTO iceberg_dws_stream.dws_trade_user_sku_order_refund_nd_full(
    user_id,
    sku_id,
    k1,
    sku_name,
