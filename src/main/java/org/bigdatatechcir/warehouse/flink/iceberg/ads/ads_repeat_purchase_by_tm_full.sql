...
CREATE TABLE IF NOT EXISTS iceberg_ads.ads_repeat_purchase_by_tm_full(
...
INSERT INTO iceberg_ads.ads_repeat_purchase_by_tm_full /*+ OPTIONS('upsert-enabled' = 'true') */(
    dt,
    recent_days,
    tm_id,
    tm_name,
