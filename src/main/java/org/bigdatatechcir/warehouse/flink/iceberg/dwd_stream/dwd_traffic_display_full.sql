...
SET 'pipeline.name' = 'iceberg_dwd_stream_dwd_traffic_display_full';
...
CREATE TABLE IF NOT EXISTS iceberg_dwd_stream.dwd_traffic_display_full(
    `id`                STRING,
...
insert into iceberg_dwd_stream.dwd_traffic_display_full(
    `id`,
    `k1`,
    `province_id`,
    `brand`,
