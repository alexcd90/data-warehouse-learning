...
SET 'pipeline.name' = 'iceberg_dwd_stream_dwd_tool_coupon_pay_full';
...
CREATE TABLE IF NOT EXISTS iceberg_dwd_stream.dwd_tool_coupon_pay_full(
...
insert into iceberg_dwd_stream.dwd_tool_coupon_pay_full(
    id,
    k1,
    coupon_id,
    user_id,
