...
SET 'pipeline.name' = 'iceberg_dwd_stream_dwd_trade_cart_add_full';
...
CREATE TABLE IF NOT EXISTS iceberg_dwd_stream.dwd_trade_cart_add_full(
...
INSERT INTO iceberg_dwd_stream.dwd_trade_cart_add_full(
    id,
    k1,
    user_id,
    sku_id,
