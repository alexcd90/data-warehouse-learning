...
SET 'pipeline.name' = 'iceberg_dwd_stream_dwd_marketing_activity_full';
...
CREATE TABLE IF NOT EXISTS iceberg_dwd_stream.dwd_marketing_activity_full(
...
WHERE ai.k1 = DATE_FORMAT(CURRENT_TIMESTAMP, 'yyyy-MM-dd');

INSERT INTO iceberg_dwd_stream.dwd_marketing_activity_full(
    id,
    k1,
    activity_id,
    activity_name,
