...
SET 'pipeline.name' = 'iceberg_dwd_stream_dwd_user_register_full';
...
CREATE TABLE IF NOT EXISTS iceberg_dwd_stream.dwd_user_register_full(
...
INSERT INTO iceberg_dwd_stream.dwd_user_register_full(
    id,
    k1,
    user_id,
    date_id,
