...
CREATE TABLE IF NOT EXISTS iceberg_ads.ads_sku_association_analysis_full(
...
INSERT INTO iceberg_ads.ads_sku_association_analysis_full /*+ OPTIONS('upsert-enabled' = 'true') */(
    dt,
    recent_days,
    source_sku_id,
    source_sku_name,
...
JOIN iceberg_dim.dim_sku_full source
    ON pair.source_sku_id = source.id
JOIN iceberg_dim.dim_sku_full target
