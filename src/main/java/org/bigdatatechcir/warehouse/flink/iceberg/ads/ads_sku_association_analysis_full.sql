...
INSERT INTO iceberg_ads.ads_sku_association_analysis_full /*+ OPTIONS('upsert-enabled' = 'true') */(dt, recent_days, source_sku_id, source_sku_name, source_category1_id, source_category1_name,
...
FROM sku_pairs pair
         JOIN iceberg_dim.dim_sku_full source ON pair.source_sku_id = source.id
         JOIN iceberg_dim.dim_sku_full target ON pair.target_sku_id = target.id
