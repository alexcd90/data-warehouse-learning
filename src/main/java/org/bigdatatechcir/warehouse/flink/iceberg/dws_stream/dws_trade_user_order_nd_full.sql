...
SET 'pipeline.name' = 'iceberg_dws_stream_dws_trade_user_order_nd_full';
...
CREATE TABLE IF NOT EXISTS iceberg_dws_stream.dws_trade_user_order_nd_full(
...
INSERT INTO iceberg_dws_stream.dws_trade_user_order_nd_full(
    user_id,
    k1,
    order_count_7d,
    order_num_7d,
