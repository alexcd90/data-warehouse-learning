...
SET 'pipeline.name' = 'iceberg_dwd_stream_dwd_interaction_comment_full';
...
CREATE TABLE IF NOT EXISTS iceberg_dwd_stream.dwd_interaction_comment_full(
...
insert into iceberg_dwd_stream.dwd_interaction_comment_full(
    id,
    k1,
    user_id,
    sku_id,
