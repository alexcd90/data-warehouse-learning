...
SET 'pipeline.name' = 'iceberg_ads_stream_ads_coupon_stats_full';
...
CREATE TABLE IF NOT EXISTS iceberg_ads_stream.ads_coupon_stats_full(
...
INSERT INTO iceberg_ads_stream.ads_coupon_stats_full(
    dt,
    coupon_id,
    coupon_name,
    start_date,
...
SELECT
    ...
    END AS reduce_rate
FROM iceberg_dws_stream.dws_trade_coupon_order_nd_full
