...
SET 'pipeline.name' = 'iceberg_dws_stream_dws_trade_province_order_1d_full';
...
CREATE TABLE IF NOT EXISTS iceberg_dws_stream.dws_trade_province_order_1d_full(
...
INSERT INTO iceberg_dws_stream.dws_trade_province_order_1d_full(
    province_id,
    k1,
    province_name,
    area_code,
