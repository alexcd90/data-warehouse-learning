...
SET 'pipeline.name' = 'iceberg_dwd_stream_dwd_user_address_full';
...
CREATE TABLE IF NOT EXISTS iceberg_dwd_stream.dwd_user_address_full(
...
INSERT INTO iceberg_dwd_stream.dwd_user_address_full(
    id,
    k1,
    user_id,
    province_id,
