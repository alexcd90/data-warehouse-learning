...
SET 'pipeline.name' = 'iceberg_dim_stream_dim_activity_full';
...
CREATE TABLE IF NOT EXISTS iceberg_dim_stream.dim_activity_full(
...
insert into iceberg_dim_stream.dim_activity_full(
    activity_rule_id,
    activity_id,
    k1,
    activity_name,
...
from
    ...
    (
        select
            ...
            end_time,
            create_time
        from iceberg_ods.ods_activity_info_full
    ) info
