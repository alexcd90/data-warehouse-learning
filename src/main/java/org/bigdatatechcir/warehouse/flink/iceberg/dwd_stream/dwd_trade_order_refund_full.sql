...
SET 'pipeline.name' = 'iceberg_dwd_stream_dwd_trade_order_refund_full';
...
CREATE TABLE IF NOT EXISTS iceberg_dwd_stream.dwd_trade_order_refund_full(
...
INSERT INTO iceberg_dwd_stream.dwd_trade_order_refund_full(
    id,
    k1,
    user_id,
    order_id,
