...
INSERT INTO iceberg_ads.ads_user_retention_full /*+ OPTIONS('upsert-enabled' = 'true') */(dt, create_date, retention_day, retention_count, new_user_count, retention_rate)
select * from iceberg_ads.ads_user_retention
union
select
...
from
    ...
    from iceberg_dwd.dwd_user_register_full            -- 使用DWD层的用户注册事实表
