...
SET 'pipeline.name' = 'iceberg_dwd_stream_dwd_marketing_seckill_full';
...
CREATE TABLE IF NOT EXISTS iceberg_dwd_stream.dwd_marketing_seckill_full(
...
INSERT INTO iceberg_dwd_stream.dwd_marketing_seckill_full(
    id,
    k1,
    seckill_id,
    spu_id,
...
FROM iceberg_ods.ods_seckill_goods_full sg
LEFT JOIN
(
    SELECT
        id,
