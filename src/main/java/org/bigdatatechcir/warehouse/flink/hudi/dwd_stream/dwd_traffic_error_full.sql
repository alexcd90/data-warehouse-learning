...
SET 'pipeline.name' = 'hudi_dwd_stream_dwd_traffic_error_full';
...
CREATE TABLE IF NOT EXISTS hudi_dwd_stream.dwd_traffic_error_full(
    `id`              STRING,
...
INSERT INTO hudi_dwd_stream.dwd_traffic_error_full(
    id,
    k1,
    province_id,
    brand,
