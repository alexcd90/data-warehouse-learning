...
SET 'pipeline.name' = 'hudi_dwd_stream_dwd_marketing_activity_full';
...
CREATE TABLE IF NOT EXISTS hudi_dwd_stream.dwd_marketing_activity_full(
...
INSERT INTO hudi_dwd_stream.dwd_marketing_activity_full(
    id,
    k1,
    activity_id,
    activity_name,
