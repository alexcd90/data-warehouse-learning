...
SET 'pipeline.name' = 'hudi_dws_stream_dws_traffic_session_page_view_1d_full';
...
CREATE TABLE IF NOT EXISTS hudi_dws_stream.dws_traffic_session_page_view_1d_full(
...
INSERT INTO hudi_dws_stream.dws_traffic_session_page_view_1d_full(
    session_id,
    mid_id,
    k1,
    brand,
