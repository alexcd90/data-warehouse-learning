...
CREATE TABLE IF NOT EXISTS hudi_dws.dws_trade_province_sku_order_nd_full(
...
INSERT INTO hudi_dws.dws_trade_province_sku_order_nd_full(
    province_id,
    sku_id,
    k1,
    province_name,
...
source_1d AS (
    SELECT
        ...
        coupon_reduce_amount_1d,
        order_total_amount_1d
    FROM hudi_dws.dws_trade_province_sku_order_1d_full
),
current_data AS (
    SELECT
        s.province_id,
