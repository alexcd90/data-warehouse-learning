...
SET 'pipeline.name' = 'hudi_dwd_stream_dwd_product_sku_info_full';
...
CREATE TABLE IF NOT EXISTS hudi_dwd_stream.dwd_product_sku_info_full(
...
FROM hudi_ods.ods_sku_info_full s
...
INSERT INTO hudi_dwd_stream.dwd_product_sku_info_full(
    id,
    k1,
    sku_id,
    spu_id,
