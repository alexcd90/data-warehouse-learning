...
SET 'pipeline.name' = 'hudi_dwd_stream_dwd_trade_cancel_detail_full';
...
CREATE TABLE IF NOT EXISTS hudi_dwd_stream.dwd_trade_cancel_detail_full(
...
INSERT INTO hudi_dwd_stream.dwd_trade_cancel_detail_full(
    id,
    k1,
    order_id,
    user_id,
