...
SET 'pipeline.name' = 'hudi_dws_stream_dws_trade_user_payment_nd_full';
...
CREATE TABLE IF NOT EXISTS hudi_dws_stream.dws_trade_user_payment_nd_full(
...
INSERT INTO hudi_dws_stream.dws_trade_user_payment_nd_full(
    user_id,
    k1,
    payment_count_7d,
    payment_num_7d,
