...
SET 'pipeline.name' = 'hudi_ads_stream_ads_sku_association_analysis_full';
...
CREATE TABLE IF NOT EXISTS hudi_ads_stream.ads_sku_association_analysis_full(
...
INSERT INTO hudi_ads_stream.ads_sku_association_analysis_full(
    dt,
    recent_days,
    source_sku_id,
    source_sku_name,
