...
SET 'pipeline.name' = 'hudi_dwd_stream_dwd_trade_cart_add_full';
...
CREATE TABLE IF NOT EXISTS hudi_dwd_stream.dwd_trade_cart_add_full(
...
INSERT INTO hudi_dwd_stream.dwd_trade_cart_add_full(
    id,
    k1,
    user_id,
    sku_id,
