...
SET 'pipeline.name' = 'hudi_ads_stream_ads_sku_cart_num_top3_by_cate_full';
...
CREATE TABLE IF NOT EXISTS hudi_ads_stream.ads_sku_cart_num_top3_by_cate_full(
...
LIKE hudi_dwd_stream.dwd_trade_cart_full;
...
INSERT INTO hudi_ads_stream.ads_sku_cart_num_top3_by_cate_full(
    dt,
    category1_id,
    category1_name,
    category2_id,
