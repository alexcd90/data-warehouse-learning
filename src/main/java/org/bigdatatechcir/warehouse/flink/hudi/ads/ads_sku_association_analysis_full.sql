...
INSERT INTO hudi_ads.ads_sku_association_analysis_full (dt, recent_days, source_sku_id, source_sku_name, source_category1_id, source_category1_name,
...
FROM sku_pairs pair
         JOIN hudi_dim.dim_sku_full source ON pair.source_sku_id = source.id
         JOIN hudi_dim.dim_sku_full target ON pair.target_sku_id = target.id
