...
SET 'pipeline.name' = 'hudi_dim_stream_dim_activity_full';
...
CREATE TABLE IF NOT EXISTS hudi_dim_stream.dim_activity_full(
...
insert into hudi_dim_stream.dim_activity_full(
    activity_rule_id,
    activity_id,
    k1,
    activity_name,
...
from
    ...
    (
        select
            ...
            end_time,
            create_time
        from hudi_ods.ods_activity_info_full
    ) info
