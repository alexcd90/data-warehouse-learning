...
INSERT INTO hudi_ads.ads_province_conversion_analysis_full (dt, recent_days, province_id, province_name, region_id, region_name, 
...
LEFT JOIN (
    ...
    FROM hudi_dwd.dwd_trade_pay_detail_suc_full
    CROSS JOIN (
        SELECT 1 AS recent_days
        UNION ALL
        SELECT 7 AS recent_days
