...
CREATE TABLE IF NOT EXISTS hudi_ads.ads_province_conversion_analysis_full(
...
LIKE hudi_dwd.dwd_trade_pay_detail_suc_full;

INSERT INTO hudi_ads.ads_province_conversion_analysis_full(
    dt,
    recent_days,
    province_id,
    province_name,
...
FROM hudi_dim.dim_province_full /*+ OPTIONS('read.streaming.enabled' = 'false') */ p
CROSS JOIN (
