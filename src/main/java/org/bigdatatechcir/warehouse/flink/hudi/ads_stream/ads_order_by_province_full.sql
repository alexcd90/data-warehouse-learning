...
SET 'pipeline.name' = 'hudi_ads_stream_ads_order_by_province_full';
...
CREATE TABLE IF NOT EXISTS hudi_ads_stream.ads_order_by_province_full(
...
INSERT INTO hudi_ads_stream.ads_order_by_province_full(
    dt,
    recent_days,
    province_id,
    province_name,
...
FROM hudi_dws_stream.dws_trade_province_order_1d_full /*+ OPTIONS('read.streaming.enabled' = 'true') */
...
FROM hudi_dws_stream.dws_trade_province_order_nd_full /*+ OPTIONS('read.streaming.enabled' = 'true') */ n
