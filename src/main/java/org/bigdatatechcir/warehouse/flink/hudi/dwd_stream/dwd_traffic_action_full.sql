...
SET 'pipeline.name' = 'hudi_dwd_stream_dwd_traffic_action_full';
...
CREATE TABLE IF NOT EXISTS hudi_dwd_stream.dwd_traffic_action_full(
    `id`               STRING,
...
insert into hudi_dwd_stream.dwd_traffic_action_full(
    id,
    k1,
    province_id,
    brand,
