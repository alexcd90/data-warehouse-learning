...
SET 'pipeline.name' = 'hudi_dws_stream_dws_trade_user_order_nd_full';
...
CREATE TABLE IF NOT EXISTS hudi_dws_stream.dws_trade_user_order_nd_full(
...
INSERT INTO hudi_dws_stream.dws_trade_user_order_nd_full(
    user_id,
    k1,
    order_count_7d,
    order_num_7d,
