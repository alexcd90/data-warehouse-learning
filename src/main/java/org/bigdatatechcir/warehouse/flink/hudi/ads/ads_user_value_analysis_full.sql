...
CREATE TABLE IF NOT EXISTS hudi_ads.ads_user_value_analysis_full(
...
LIKE hudi_dws.dws_trade_user_order_td_full;
...
LIKE hudi_ads.ads_user_value_analysis_full;
...
INSERT INTO hudi_ads.ads_user_value_analysis_full(
    dt,
    user_id,
    order_count_td,
    order_amount_td,
