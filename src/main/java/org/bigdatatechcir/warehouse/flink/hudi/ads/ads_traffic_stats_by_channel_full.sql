...
CREATE TABLE IF NOT EXISTS hudi_ads.ads_traffic_stats_by_channel_full(
...
INSERT INTO hudi_ads.ads_traffic_stats_by_channel_full(
    dt,
    recent_days,
    channel,
    uv_count,
...
JOIN hudi_dws.dws_traffic_session_page_view_1d_full /*+ OPTIONS('read.streaming.enabled' = 'false') */ s
