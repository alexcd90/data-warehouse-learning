...
SET 'pipeline.name' = 'hudi_dws_stream_dws_trade_activity_order_nd_full';
...
CREATE TABLE IF NOT EXISTS hudi_dws_stream.dws_trade_activity_order_nd_full(
...
CREATE TEMPORARY VIEW tmp_dws_trade_activity_order_nd_activity_union AS
    ...
    FROM hudi_dim.dim_activity_full /*+ OPTIONS('read.streaming.enabled' = 'true') */
...
INSERT INTO hudi_dws_stream.dws_trade_activity_order_nd_full(
    activity_id,
    k1,
    activity_name,
    activity_type_code,
