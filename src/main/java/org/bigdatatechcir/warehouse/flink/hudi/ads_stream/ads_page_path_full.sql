...
SET 'pipeline.name' = 'hudi_ads_stream_ads_page_path_full';
...
CREATE TABLE IF NOT EXISTS hudi_ads_stream.ads_page_path_full(
...
JOIN hudi_dwd_stream.dwd_traffic_page_view_full /*+ OPTIONS('read.streaming.enabled' = 'true') */ pv
...
INSERT INTO hudi_ads_stream.ads_page_path_full(
    dt,
    recent_days,
    source,
    target,
