...
SET 'pipeline.name' = 'hudi_ads_stream_ads_user_value_analysis_full';
...
CREATE TABLE IF NOT EXISTS hudi_ads_stream.ads_user_value_analysis_full(
...
CREATE TEMPORARY TABLE tmp_ads_user_value_analysis_dim_user_zip_snapshot
WITH (
    'read.streaming.enabled' = 'false'
)
LIKE hudi_dim.dim_user_zip_full;

CREATE TEMPORARY TABLE tmp_ads_user_value_analysis_order_td_snapshot
WITH (
    'read.streaming.enabled' = 'false'
)
LIKE hudi_dws_stream.dws_trade_user_order_td_full;

CREATE TEMPORARY TABLE tmp_ads_user_value_analysis_login_td_snapshot
WITH (
    'read.streaming.enabled' = 'false'
)
LIKE hudi_dws_stream.dws_user_user_login_td_full;

CREATE TEMPORARY TABLE tmp_ads_user_value_analysis_previous_score_snapshot
WITH (
    'read.streaming.enabled' = 'false'
)
LIKE hudi_ads_stream.ads_user_value_analysis_full;
...
INSERT INTO hudi_ads_stream.ads_user_value_analysis_full(
    dt,
    user_id,
    order_count_td,
    order_amount_td,
