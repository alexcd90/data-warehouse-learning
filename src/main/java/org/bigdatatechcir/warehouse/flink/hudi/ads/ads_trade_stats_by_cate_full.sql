...
CREATE TABLE IF NOT EXISTS hudi_ads.ads_trade_stats_by_cate_full(
...
FROM hudi_dws.dws_trade_user_sku_order_1d_full /*+ OPTIONS('read.streaming.enabled' = 'false') */ o
WHERE o.k1 = '${pdate}'
...
JOIN hudi_dws.dws_trade_user_sku_order_nd_full /*+ OPTIONS('read.streaming.enabled' = 'false') */ o
    ON o.k1 = '${pdate}'
...
FROM hudi_dws.dws_trade_user_sku_order_refund_1d_full /*+ OPTIONS('read.streaming.enabled' = 'false') */ r
WHERE r.k1 = '${pdate}'
...
FROM tmp_ads_trade_stats_by_cate_recent_days p
JOIN hudi_dws.dws_trade_user_sku_order_refund_nd_full /*+ OPTIONS('read.streaming.enabled' = 'false') */ r
    ON r.k1 = '${pdate}'
...
INSERT INTO hudi_ads.ads_trade_stats_by_cate_full(
    dt,
    recent_days,
    category1_id,
    category1_name,
