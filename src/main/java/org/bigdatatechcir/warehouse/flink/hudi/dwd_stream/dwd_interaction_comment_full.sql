...
SET 'pipeline.name' = 'hudi_dwd_stream_dwd_interaction_comment_full';
...
CREATE TABLE IF NOT EXISTS hudi_dwd_stream.dwd_interaction_comment_full(
...
insert into hudi_dwd_stream.dwd_interaction_comment_full(
    id,
    k1,
    user_id,
    sku_id,
